...
const { coerceQueryParams } = require(".././_common/coerceQueryParams");
/**
  ...
  async mw(req, res, next) {
    ...
    let hotBolt = this.mwsExec.createBolt({
      ...
      onDone: async ({ req, res, results }) => {
         ...
         *  data = query (coerced) + body + middleware results; validators run on this.
         */
        const query = coerceQueryParams(req.query || {});
        const body = req.body || {};
        const data = {
          ...query,
          ...body,
