...
const swaggerSpec = {
  ...
  info: {
    ...
    version: "1.0.0",
    description:
      "RESTful API for managing schools, classrooms, and students with JWT authentication and role-based access (superadmin, school_admin).",
  ...
  servers: [
    {
      url:
        ...
        `http://localhost:${process.env.USER_PORT || 5111}`,
      description:
  ...
  tags: [
    ...
    {
      name: "Grades",
      description: "Grade CRUD per school (school -> grade -> classroom)",
    },
  ...
  components: {
    securitySchemes: {
      bearerAuth: {
        ...
        bearerFormat: "JWT",
        description:
          "Short token from POST /api/token/v1_createShortToken. Send in header: token",
      },
    },
    schemas: {
      User: {
